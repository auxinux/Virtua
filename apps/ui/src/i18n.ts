...
const fallbackResources = {
  EN: {
    translation: {
      ...
      "crash.scopeTitle": "Unexpected shutdowns",
      "crash.scopeDesc": "Every VM or container that stops without a Virtua command is logged here with its cause. Automatic restart is configured per machine (its Crashes tab) or globally in Settings.",
      "crash.eventsCount": "event(s)",
      "crash.clear": "Clear log",
      "crash.confirmClear": "Clear the crash log?",
      "crash.colTime": "Time",
      "crash.colResource": "Machine",
      "crash.colEvent": "Event",
      "crash.colReason": "Cause",
      "crash.colDetail": "Detail",
      "crash.noEvents": "No crash recorded",
      "crash.noDetail": "No detail",
      "crash.eventCrash": "Crash",
      "crash.eventRestart": "Restarted",
      "crash.eventRestartFailed": "Restart failed",
      "crash.eventGaveUp": "Gave up",
      "crash.reasonCrashed": "Crash reported by libvirt",
      "crash.reasonFailed": "Process failure",
      "crash.reasonPanicked": "Guest kernel panic",
      "crash.reasonKilled": "Process killed",
      "crash.reasonUnexpected": "Unexpected shutdown",
      "crash.policyTitle": "Automatic restart after a crash",
      "crash.policyHelp": "If this machine stops without being asked to, Virtua can restart it automatically.",
      "crash.policyDefault": "Node default",
      "crash.policyOn": "Always restart",
      "crash.policyOff": "Never restart",
      "crash.settingsTitle": "Crash recovery",
      "crash.settingsDesc": "Default behaviour when a VM or container stops without a Virtua command. Each machine can override it from its Crashes tab.",
      "crash.settingsDefaultRestart": "Automatically restart machines after a crash",
      "crash.settingsMaxAttempts": "Maximum attempts",
      "crash.settingsWindow": "Window (minutes)",
      "crash.settingsAntiLoop": "Anti-loop guard: beyond this many restarts within the window, the machine is left stopped and the give-up is written to the log. Default: 3 attempts in 10 minutes.",
      "logs.title": "Logs",
      "logs.tabTasks": "Tasks",
      "logs.tabAudit": "Audit",
